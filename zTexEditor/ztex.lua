...
function ztex:Save(playerid)
	for i = 1, GetTextures() do
		LogString("(zTex) resultTexEditor", "UpdateTextureSize(arg "..i..", "..ztex[i].x1..", "..ztex[i].y1..", "..ztex[i].x2..", "..ztex[i].y2..", '"..ztex[i].tex.."')" )
		...
		LogString("(zTex) resultTexEditor", "UpdateTexture(arg "..i..", "..nax(playerid, ztex[i].x1)..", "..nay(playerid, ztex[i].y1)..", "..nax(playerid, ztex[i].x2)..", "..nay(playerid, ztex[i].y2)..", '"..ztex[i].tex.."')" )
	end
end
